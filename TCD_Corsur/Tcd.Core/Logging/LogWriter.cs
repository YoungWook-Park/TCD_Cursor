...
namespace Tcd.Core.Logging
{
    ...
    public sealed class LogWriter : ILogWriter
    {
            ...
            IReadOnlyDictionary<string, object> data = null, Exception ex = null)
        {
            ...
            {
                // Queue full: optionally could prioritize Error/Fatal by dropping oldest; here we just drop new entry.
            }
        }
        ...
        private async Task ConsumeAsync(CancellationToken ct)
        {
            ...
            while (!ct.IsCancellationRequested)
            {
                ...
                if (batch.Count > 0)
                {
                    ...
                    {
                        // avoid killing consumer; skip batch or retry could be added
                    }
                }
