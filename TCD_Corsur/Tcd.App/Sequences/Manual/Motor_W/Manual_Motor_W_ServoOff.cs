...
/// <summary>W축 서보 OFF.</summary>
public sealed class ManualMotorWServoOffSequence : ISequence
{
    #region Variables

    private const string AxisName = AxisDefine.W;

    public string Key => TcdSequenceKeys.Manual_Motor_W_ServoOff;
    public string DisplayName => "Manual Motor W ServoOff";
