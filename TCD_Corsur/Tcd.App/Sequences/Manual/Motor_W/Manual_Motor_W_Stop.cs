...
/// <summary>W축 정지.</summary>
public sealed class ManualMotorWStopSequence : ISequence
{
    #region Variables

    private const string AxisName = AxisDefine.W;

    public string Key => TcdSequenceKeys.Manual_Motor_W_Stop;
    public string DisplayName => "Manual Motor W Stop";
