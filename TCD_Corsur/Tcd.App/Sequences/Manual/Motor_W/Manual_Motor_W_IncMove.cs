...
/// <summary>W축 증분 이동. 파라미터는 이동량(delta, double).</summary>
public sealed class ManualMotorWIncMoveSequence : ISequence
{
    #region Variables

    private const string AxisName = AxisDefine.W;

    public string Key => TcdSequenceKeys.Manual_Motor_W_IncMove;
    public string DisplayName => "Manual Motor W IncMove";
