...
/// <summary>W축 홈 복귀.</summary>
public sealed class ManualMotorWHomeSequence : ISequence
{
    #region Variables

    private const string AxisName = AxisDefine.W;

    public string Key => TcdSequenceKeys.Manual_Motor_W_Home;
    public string DisplayName => "Manual Motor W Home";
