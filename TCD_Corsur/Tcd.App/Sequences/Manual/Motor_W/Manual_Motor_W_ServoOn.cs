...
/// <summary>W축 서보 ON.</summary>
public sealed class ManualMotorWServoOnSequence : ISequence
{
    #region Variables

    private const string AxisName = AxisDefine.W;

    public string Key => TcdSequenceKeys.Manual_Motor_W_ServoOn;
    public string DisplayName => "Manual Motor W ServoOn";
