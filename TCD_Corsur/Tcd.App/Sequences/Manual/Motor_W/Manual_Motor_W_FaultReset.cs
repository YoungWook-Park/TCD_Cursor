...
/// <summary>W축 결함 리셋.</summary>
public sealed class ManualMotorWFaultResetSequence : ISequence
{
    #region Variables

    private const string AxisName = AxisDefine.W;

    public string Key => TcdSequenceKeys.Manual_Motor_W_FaultReset;
    public string DisplayName => "Manual Motor W FaultReset";
