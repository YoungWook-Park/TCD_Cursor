...
/// <summary>V축 결함 리셋.</summary>
public sealed class ManualMotorVFaultResetSequence : ISequence
{
    #region Variables

    private const string AxisName = AxisDefine.V;

    public string Key => TcdSequenceKeys.Manual_Motor_V_FaultReset;
    public string DisplayName => "Manual Motor V FaultReset";
