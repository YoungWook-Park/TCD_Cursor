...
/// <summary>V축 홈 복귀.</summary>
public sealed class ManualMotorVHomeSequence : ISequence
{
    #region Variables

    private const string AxisName = AxisDefine.V;

    public string Key => TcdSequenceKeys.Manual_Motor_V_Home;
    public string DisplayName => "Manual Motor V Home";
