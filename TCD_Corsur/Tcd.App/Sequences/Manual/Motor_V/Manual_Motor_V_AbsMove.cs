...
/// <summary>V축 절대 위치 이동. 목표값은 레시피(축키 V)에서 참조.</summary>
public sealed class ManualMotorVAbsMoveSequence : ISequence
{
    #region Variables

    private const string AxisName = AxisDefine.V;

    public string Key => TcdSequenceKeys.Manual_Motor_V_AbsMove;
    public string DisplayName => "Manual Motor V AbsMove";
