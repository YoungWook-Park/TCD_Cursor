...
/// <summary>V축 서보 ON.</summary>
public sealed class ManualMotorVServoOnSequence : ISequence
{
    #region Variables

    private const string AxisName = AxisDefine.V;

    public string Key => TcdSequenceKeys.Manual_Motor_V_ServoOn;
    public string DisplayName => "Manual Motor V ServoOn";
