...
/// <summary>V축 정지.</summary>
public sealed class ManualMotorVStopSequence : ISequence
{
    #region Variables

    private const string AxisName = AxisDefine.V;

    public string Key => TcdSequenceKeys.Manual_Motor_V_Stop;
    public string DisplayName => "Manual Motor V Stop";
