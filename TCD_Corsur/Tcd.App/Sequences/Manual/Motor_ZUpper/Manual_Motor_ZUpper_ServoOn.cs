...
/// <summary>ZUpper축 서보 ON.</summary>
public sealed class ManualMotorZUpperServoOnSequence : ISequence
{
    #region Variables

    private const string AxisName = AxisDefine.ZUpper;

    public string Key => TcdSequenceKeys.Manual_Motor_ZUpper_ServoOn;
    public string DisplayName => "Manual Motor ZUpper ServoOn";
