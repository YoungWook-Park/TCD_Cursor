...
/// <summary>ZUpper축 절대 위치 이동. 목표값은 레시피(축키 Z_Bond)에서 참조.</summary>
public sealed class ManualMotorZUpperAbsMoveSequence : ISequence
{
    #region Variables

    private const string AxisName = AxisDefine.ZUpper;

    public string Key => TcdSequenceKeys.Manual_Motor_ZUpper_AbsMove;
    public string DisplayName => "Manual Motor ZUpper AbsMove";
