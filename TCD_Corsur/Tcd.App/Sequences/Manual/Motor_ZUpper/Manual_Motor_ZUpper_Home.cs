...
/// <summary>ZUpper축 홈 복귀.</summary>
public sealed class ManualMotorZUpperHomeSequence : ISequence
{
    #region Variables

    private const string AxisName = AxisDefine.ZUpper;

    public string Key => TcdSequenceKeys.Manual_Motor_ZUpper_Home;
    public string DisplayName => "Manual Motor ZUpper Home";
