...
/// <summary>ZUpper축 서보 OFF.</summary>
public sealed class ManualMotorZUpperServoOffSequence : ISequence
{
    #region Variables

    private const string AxisName = AxisDefine.ZUpper;

    public string Key => TcdSequenceKeys.Manual_Motor_ZUpper_ServoOff;
    public string DisplayName => "Manual Motor ZUpper ServoOff";
