...
/// <summary>ZUpper축 결함 리셋.</summary>
public sealed class ManualMotorZUpperFaultResetSequence : ISequence
{
    #region Variables

    private const string AxisName = AxisDefine.ZUpper;

    public string Key => TcdSequenceKeys.Manual_Motor_ZUpper_FaultReset;
    public string DisplayName => "Manual Motor ZUpper FaultReset";
