...
/// <summary>ZUpper축 증분 이동. 파라미터는 이동량(delta, double).</summary>
public sealed class ManualMotorZUpperIncMoveSequence : ISequence
{
    #region Variables

    private const string AxisName = AxisDefine.ZUpper;

    public string Key => TcdSequenceKeys.Manual_Motor_ZUpper_IncMove;
    public string DisplayName => "Manual Motor ZUpper IncMove";
