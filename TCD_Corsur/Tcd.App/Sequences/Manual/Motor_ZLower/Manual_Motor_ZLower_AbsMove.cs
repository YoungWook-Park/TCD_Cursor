...
/// <summary>ZLower축 절대 위치 이동. 목표값은 레시피(축키 Z_Load)에서 참조.</summary>
public sealed class ManualMotorZLowerAbsMoveSequence : ISequence
{
    #region Variables

    private const string AxisName = AxisDefine.ZLower;

    public string Key => TcdSequenceKeys.Manual_Motor_ZLower_AbsMove;
    public string DisplayName => "Manual Motor ZLower AbsMove";
