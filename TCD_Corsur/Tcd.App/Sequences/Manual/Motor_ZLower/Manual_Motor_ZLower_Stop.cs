...
/// <summary>ZLower축 정지.</summary>
public sealed class ManualMotorZLowerStopSequence : ISequence
{
    #region Variables

    private const string AxisName = AxisDefine.ZLower;

    public string Key => TcdSequenceKeys.Manual_Motor_ZLower_Stop;
    public string DisplayName => "Manual Motor ZLower Stop";
