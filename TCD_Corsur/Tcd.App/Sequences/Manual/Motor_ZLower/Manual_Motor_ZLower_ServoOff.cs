...
/// <summary>ZLower축 서보 OFF.</summary>
public sealed class ManualMotorZLowerServoOffSequence : ISequence
{
    #region Variables

    private const string AxisName = AxisDefine.ZLower;

    public string Key => TcdSequenceKeys.Manual_Motor_ZLower_ServoOff;
    public string DisplayName => "Manual Motor ZLower ServoOff";
