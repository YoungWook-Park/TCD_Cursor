...
/// <summary>ZLower축 증분 이동. 파라미터는 이동량(delta, double).</summary>
public sealed class ManualMotorZLowerIncMoveSequence : ISequence
{
    #region Variables

    private const string AxisName = AxisDefine.ZLower;

    public string Key => TcdSequenceKeys.Manual_Motor_ZLower_IncMove;
    public string DisplayName => "Manual Motor ZLower IncMove";
