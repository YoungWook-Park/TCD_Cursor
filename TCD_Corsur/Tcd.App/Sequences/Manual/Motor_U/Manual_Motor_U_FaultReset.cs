...
namespace Tcd.App.Sequences.Manual.Motor_U;

/// <summary>U축 결함 리셋.</summary>
public sealed class ManualMotorUFaultResetSequence : ISequence
{
    #region Variables

    private const string AxisName = AxisDefine.U;

    public string Key => TcdSequenceKeys.Manual_Motor_U_FaultReset;
    public string DisplayName => "Manual Motor U FaultReset";
