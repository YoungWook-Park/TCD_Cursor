...
/// <summary>U축 증분 이동. 파라미터는 이동량(delta, double).</summary>
public sealed class ManualMotorUIncMoveSequence : ISequence
{
    #region Variables

    private const string AxisName = AxisDefine.U;

    public string Key => TcdSequenceKeys.Manual_Motor_U_IncMove;
    public string DisplayName => "Manual Motor U IncMove";
