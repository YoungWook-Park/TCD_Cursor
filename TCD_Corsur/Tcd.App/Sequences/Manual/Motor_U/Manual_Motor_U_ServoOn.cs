...
/// <summary>U축 서보 ON.</summary>
public sealed class ManualMotorUServoOnSequence : ISequence
{
    #region Variables

    private const string AxisName = AxisDefine.U;

    public string Key => TcdSequenceKeys.Manual_Motor_U_ServoOn;
    public string DisplayName => "Manual Motor U ServoOn";
