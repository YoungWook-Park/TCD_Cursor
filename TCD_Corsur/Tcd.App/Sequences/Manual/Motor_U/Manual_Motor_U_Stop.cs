...
/// <summary>U축 정지.</summary>
public sealed class ManualMotorUStopSequence : ISequence
{
    #region Variables

    private const string AxisName = AxisDefine.U;

    public string Key => TcdSequenceKeys.Manual_Motor_U_Stop;
    public string DisplayName => "Manual Motor U Stop";
