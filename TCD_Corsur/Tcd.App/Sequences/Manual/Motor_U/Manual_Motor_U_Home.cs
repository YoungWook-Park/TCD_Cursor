...
/// <summary>U축 홈 복귀.</summary>
public sealed class ManualMotorUHomeSequence : ISequence
{
    #region Variables

    private const string AxisName = AxisDefine.U;

    public string Key => TcdSequenceKeys.Manual_Motor_U_Home;
    public string DisplayName => "Manual Motor U Home";
