...
/// <summary>U축 서보 OFF.</summary>
public sealed class ManualMotorUServoOffSequence : ISequence
{
    #region Variables

    private const string AxisName = AxisDefine.U;

    public string Key => TcdSequenceKeys.Manual_Motor_U_ServoOff;
    public string DisplayName => "Manual Motor U ServoOff";
