...
/// <summary>U축 절대 위치 이동. 목표값은 레시피(축키 U)에서 참조.</summary>
public sealed class ManualMotorUAbsMoveSequence : ISequence
{
    #region Variables

    private const string AxisName = AxisDefine.U;

    public string Key => TcdSequenceKeys.Manual_Motor_U_AbsMove;
    public string DisplayName => "Manual Motor U AbsMove";
